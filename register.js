...
function showData() {
  ...
  if (user_records) {
    for (let i = 0; i < user_records.length; i++) {
      ...
      addRow.innerHTML = `<td style="width:450px;">${user_records[i].name}</td><td style="width:450px;">${user_records[i].email}
   </td><td><a href=../html/edit-users.html?id=${user_records[i].id}>Edit</a>|<a href=../html/delete.html?id=${user_records[i].id}>Delete</a></td>`;
      // console.log(addRow);
